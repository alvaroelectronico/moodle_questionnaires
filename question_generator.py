...
def create_xml_elem(category_name_str, question_name_str, question_text_str, answer_str, tolerance_str):
    quiz = Element("quiz")
    ...
    answer = SubElement(question, "answer", fraction="100", fomrat="moodle_auto_format")
...
quiz = check_release_file(category_name_str, question_name_str, question_text_str, answer_str, tolerance_str)

# Prettifying and saving the pretty string to an .xml file
save_to_file(quiz, "prueba.xml")
